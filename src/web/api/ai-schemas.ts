...
export const aiUsageSummarySchema = z.object({
  ...
  errorCount: z.number(),
  errorRate: z.number().nullable().default(null),
  ...
  promptCacheCreationRate: z.number().nullable().default(null),
  promptCacheReadRate: z.number().nullable().default(null),
  avgLatencyMs: z.number().nullable().default(null),
  p95LatencyMs: z.number().nullable().default(null),
  avgUpstreamTtfbMs: z.number().nullable().default(null),
  p95UpstreamTtfbMs: z.number().nullable().default(null),
  avgTokensPerSecond: z.number().nullable().default(null),
  p95TokensPerSecond: z.number().nullable().default(null),
