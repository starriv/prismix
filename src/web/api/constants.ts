...
export const apiUserKeyDisable = (id: number) => `/api/user/keys/${id}/disable`;
export const apiUserKeyEnable = (id: number) => `/api/user/keys/${id}/enable`;
export const apiUserKeyReveal = (id: number) => `/api/user/keys/${id}/reveal`;
