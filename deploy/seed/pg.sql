...
VALUES (
  'ai_endpoint_catalog',
  '[{"supplierId":"openai","supplierName":"OpenAI","endpointId":"openai","name":"OpenAI","baseUrl":"https://api.openai.com/v1","apiFormat":"openai","authType":"bearer","iconUrl":"https://svgl.app/library/openai.svg"},{"supplierId":"anthropic","supplierName":"Anthropic","endpointId":"anthropic","name":"Anthropic","baseUrl":"https://api.anthropic.com/v1","apiFormat":"anthropic","authType":"api-key","authConfig":{"headerName":"x-api-key"},"iconUrl":"https://svgl.app/library/anthropic_black.svg"},{"supplierId":"google","supplierName":"Google AI","endpointId":"google","name":"Google AI","baseUrl":"https://generativelanguage.googleapis.com/v1beta","apiFormat":"gemini","authType":"bearer","iconUrl":"https://svgl.app/library/gemini.svg"},{"supplierId":"deepseek","supplierName":"DeepSeek","endpointId":"deepseek-openai","name":"DeepSeek OpenAI","baseUrl":"https://api.deepseek.com","apiFormat":"openai","authType":"bearer","iconUrl":"https://svgl.app/library/deepseek.svg"},{"supplierId":"groq","supplierName":"Groq","endpointId":"groq-openai","name":"Groq OpenAI","baseUrl":"https://api.groq.com/openai/v1","apiFormat":"openai","authType":"bearer","iconUrl":"https://svgl.app/library/groq.svg"},{"supplierId":"bedrock","supplierName":"AWS Bedrock","endpointId":"bedrock-us-east-1","name":"AWS Bedrock us-east-1","baseUrl":"https://bedrock-runtime.us-east-1.amazonaws.com","apiFormat":"bedrock","authType":"sigv4","authConfig":{"region":"us-east-1","service":"bedrock","accessKeyId":""},"iconUrl":"https://svgl.app/library/aws_light.svg"}]',
  NOW(),
  NOW()
)
ON CONFLICT (key) DO NOTHING;
